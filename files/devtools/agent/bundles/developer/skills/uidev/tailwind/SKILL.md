...
- [Rule template](files/assets/templates/_template.md) - Template for adding new rules
...
| [files/assets/templates/_template.md](files/assets/templates/_template.md) | Template for new rules |
