...
Apply this skill to the user's `WritingTask` when the American business English command is requested. Use EN-US spelling and a direct, action-oriented tone.
