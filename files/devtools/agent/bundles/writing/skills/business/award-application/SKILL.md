...
Use the user's request as the application brief. If it includes an award name, use it. Otherwise ask for the award name, details, and criteria before drafting.
