...
One file per resource group. Use the template from [files/assets/route-template.ts](files/assets/route-template.ts):
...
Based on project needs, add from [files/assets/middleware-template.ts](files/assets/middleware-template.ts):
...
Use the standard error handler from [files/assets/error-handler.ts](files/assets/error-handler.ts):
...
| File | Purpose |
|------|---------|
| [files/assets/route-template.ts](files/assets/route-template.ts) | Starter route file with CRUD + Zod |
| [files/assets/middleware-template.ts](files/assets/middleware-template.ts) | Auth middleware template |
| [files/assets/error-handler.ts](files/assets/error-handler.ts) | Standard JSON error handler |
