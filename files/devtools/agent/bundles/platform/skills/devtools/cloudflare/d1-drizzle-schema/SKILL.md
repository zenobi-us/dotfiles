...
Copy [files/assets/drizzle-config-template.ts](files/assets/drizzle-config-template.ts) to `drizzle.config.ts` and update the schema path.
...
| File | Purpose |
|------|---------|
| [files/assets/drizzle-config-template.ts](files/assets/drizzle-config-template.ts) | Starter drizzle.config.ts for D1 |
| [files/assets/schema-template.ts](files/assets/schema-template.ts) | Example schema with all common D1 patterns |
