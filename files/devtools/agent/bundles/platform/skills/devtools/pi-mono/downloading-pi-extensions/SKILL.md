...
description: Use when installing third-party pi extensions from GitHub into files/devtools/pi/agent/extensions using gh download
---
...
`/mnt/Store/Projects/Mine/Github/Dotfiles/devtools/pi/agent/extensions/`
...
```bash
gh download <owner>/<repository> [...filepaths] --outdir /mnt/Store/Projects/Mine/Github/Dotfiles/devtools/pi/agent/extensions/<extension-name>
```
