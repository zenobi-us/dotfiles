...
- **[P0]** — Drop everything. Will break production, lose data, or create a security hole. Must be provable. **Includes:** leaking files/secrets/answers to clients, auth bypass, data exposure via auto-sync/broadcast mechanisms.
