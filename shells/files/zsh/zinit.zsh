...
zinit_load_env_modules() {
  ...
  [[ "$OSTYPE" == linux* ]] && zinit_load_local_module "gnome__env.zsh"
...
zinit_load_interactive_modules() {
  ...
  zinit_load_local_module "autocomplete__config.zsh"
  zinit_load_local_module "cli__config.zsh"
  zinit_load_local_module "fzf__config.zsh"
  ...
  zinit_load_local_module "tabtab__config.zsh"
