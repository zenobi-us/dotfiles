...
helper_current_ghostty_font() {
  local config_file
  config_file="$(helper_config_path "shells/ghostty/config")" || return 1
...
helper_current_alacritty_font() {
  local config_file
  config_file="$(helper_config_path "shells/alacritty/alacritty.toml")" || return 1
  [[ -f "$config_file" ]] || return 0
...
handler_ghostty() {
  ...
  config_file="$(helper_config_path "shells/ghostty/config")" || {
...
handler_alacritty() {
  ...
  config_file="$(helper_config_path "shells/alacritty/alacritty.toml")" || {
    echo "shellfont: could not resolve repository root" >&2
    return 1
  }
