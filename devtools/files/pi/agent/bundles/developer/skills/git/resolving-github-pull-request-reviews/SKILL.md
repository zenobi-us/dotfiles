---
name: resolving-github-pull-request-reviews
description: Describes the process of resolving pull request CI checks and review comments. Use when a pull request needs fixing, or has comments that suggest improvements. Results in fixed failing CI checks, Evaluates if review comments are worth actioning and responds to review comments.
---
