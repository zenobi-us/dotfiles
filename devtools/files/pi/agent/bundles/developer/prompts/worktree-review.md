...
- Treat the Matt Pocock shared context as durable project memory. Resolve `ALIGNMENT_ROOT` from `<matt-pocock-context>` or fall back to the repository root. Follow `ALIGNMENT-ROOT.md` before reading alignment files.
