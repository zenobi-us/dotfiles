...
description: Research a topic deeply while being aware of biases and ensuring correct references. Use when a topic needs deep research that requires collecting and verifying sources. The agent crawls, collates, verifies, and fact-checks information, providing evidence of its verification process.
---
