...
// Convenience factory: Copilot Spark (premium model)
export function createCopilotSparkProviders(): Array<{
  ...
  return [
    ...
    {
      name: "copilot-spark-remaining-percent",
      provider: createWindowQuotaRemainingPercentageProvider(
        "copilot",
        "spark",
        "30_day",
    ...
    {
      name: "copilot-spark-remaining-amount",
      provider: createWindowRemainingAmountProvider(
        "copilot",
        "spark",
        "30_day",
...
// Convenience factory: Anthropic default model windows
export function createAnthropicProviders(): Array<{
  ...
  return [
    {
      name: "anthropic-5hour-used-percent",
      provider: createWindowProgressPercentageProvider(
        "anthropic",
        "default",
        "5_hour",
    ...
    {
      name: "anthropic-5day-used-percent",
      provider: createWindowProgressPercentageProvider(
        "anthropic",
        "default",
        "5_day",
    ...
    {
      name: "anthropic-5hour-remaining-percent",
      provider: createWindowQuotaRemainingPercentageProvider(
        "anthropic",
        "default",
        "5_hour",
