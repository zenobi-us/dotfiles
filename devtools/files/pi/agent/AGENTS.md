...
- **Chesterton's Fence**: If you can't explain why something exists, don't touch it until you can.
...
- **Ambiguity**: When confused: stop, think, present theories, get signoff. Never silently retry failures. Q will be unhappy if you try to silenty retry after multiple failures.
- **Ask Tool**: Always use the ask tool to get input from the user. This means Yes/No, Confirm/Deny, Approve/Reject, or multiple choice questions. If you don't have a tool for this, ask Q to create one.
- **Multi-Step Questions**: If you know what questions you'll ask, ask them all at once. Don't ask one question, wait for answer, then ask next. This is inefficient and frustrating for Q.
