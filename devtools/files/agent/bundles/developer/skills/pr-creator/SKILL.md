...
- DefaultBranch: Run `gh repo view --json defaultBranchRef --template '{{.defaultBranchRef.name}}'` to get the default branch.
...
2. Stop if the current branch is the default branch.
...
4. Verify ArtifactReference is provided:
