...
description: Reviews supplied documentation for structure, coverage, clarity, accuracy, and usability; use for README and technical documentation audits; produces prioritised findings and exact edit recommendations.
---
