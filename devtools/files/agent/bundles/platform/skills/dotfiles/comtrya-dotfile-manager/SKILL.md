...
## Dotfile Onboarding Reference

For bringing **new unmanaged local config files** under comtrya symlink management in this repo, use:

- `references/dotfile-management-workflow.md`

This reference defines the required onboarding flow: copy local config into `<module>/files/...`, add `file.link`, dry-run, apply, and verify managed symlink state.
