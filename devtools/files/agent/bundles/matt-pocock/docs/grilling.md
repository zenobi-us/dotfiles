...
`grilling` is the interview **primitive** under the main build chain: use skill grill-with-docs runs it to sharpen context before use skill to-spec writes the spec. When you're unsure which entry point fits, use skill ask-matt routes you.
