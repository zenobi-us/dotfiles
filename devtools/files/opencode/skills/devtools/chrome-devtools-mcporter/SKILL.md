---
name: chrome-devtools-mcporter
description: Use when integrating Chrome DevTools MCP server into mcporter configuration - provides setup pattern, connection prerequisites, and troubleshooting for browser automation and debugging workflows
---
...
Chrome must be launched with remote debugging enabled **before** starting mcporter:
...
|------|-----------------|
| Launch Chrome for debugging | `google-chrome --remote-debugging-port=9222 &` |
| Check Chrome listening | `curl http://127.0.0.1:9222/json/version` |
| List browser tabs | "List all open tabs" (to Claude with MCP) |
| Take screenshot | "Take a screenshot of the current page" |
| Click element | "Click the submit button" or "Click element with ID 'login'" |
| Fill form field | "Fill the email field with test@example.com" |
| Get page content | "Read the page content and tell me what's displayed" |
