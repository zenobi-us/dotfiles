...
Never use any other tools. Never use bash commands to perform the search.
...
- Use the `skill_find` tool to search for skills that match the identified keywords. (this is not a bash command, it's a tool available to you).
