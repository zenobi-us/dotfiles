...
3. Is the `.memory/` directory is itself a git repo? 
  - **YES** then after each change, commit and push the changes with a conventional commit message from within that directory.
