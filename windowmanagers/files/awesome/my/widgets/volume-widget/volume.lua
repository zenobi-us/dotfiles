...
local utils = require("my.widgets.volume-widget.utils")

local Class = require('my.core.class')


local VolumeWidget = {}
local VolumeWidgetMt = Class(VolumeWidget)
...
local function worker(user_args)
    ...
    local widget_type = assert(args.widget_type, "A widget_type is required")
